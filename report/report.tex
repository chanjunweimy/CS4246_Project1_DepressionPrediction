...
\begin{document}
	...
	\subsubsection{Hypothesis: Doing feature selection before applying to the ARD Kernel GP model will improve the result.}
	...
	This confirms our hypothesis that MFCC gives the best predictive power to predict PHQ-8. 
