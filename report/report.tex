...
to predict PHQ-8 scores.
	...
	\section{Conclusion}	
	Our work has succesfully shown that GP is a good model to this problem and can predict PHQ-8 better than the algorithms presented.
	Overall, we conclude the GP Dot Product trained using MFCC features is a good model for depression
	prediction.\\
