...
\begin{document}
	...
	The Personal Health Questionaire depression scale (PHQ-8) is one of the many established diagnostic and severity measures for depressive disorders in large clinical studies and it has been proven to be an effective depression measure \cite{jad2008}. Nevertheless, one of the biggest obstacles to successful diagnosis of depression is the unwillingness of people to admit their predisposition to depression by seeking help.\\

	Patients often subscribe to the social stigma that being depressed reflects a weakness in their character, a permanent defect in their personality, and that hiding it from others gives them a better shot at living a normal life. Even if they do seek help, the accuracy of the PHQ-8 or just questionaires and surveys in general are often adversely affected by the Hawthorne Effect which is a type of reactivity in which individuals modify or improve an aspect of their behavior in response to their awareness of being observed. \cite{jce2014}.\\

	There has been research that correlates emotion with voice production and speech acoustics \cite{uwa2001}. Corollary to that, active research of late into the use of voice acoustics as predictors of clinical depression scores has seen some success, proving that it is an effective indicator of depression severity \cite{jov2016}.\\
