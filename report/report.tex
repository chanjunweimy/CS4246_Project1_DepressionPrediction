...
\begin{document}
	...
	Left unchecked, depression increases risk for morbidity, suicide, decreased cognitive and social functioning, self-neglect, and early death \cite{arcp2009}. Death from suicide is one of the top 10 causes of death, above the death rate for chronic liver disease, AlzheimerÃ¢â‚¬â„¢s, homicide, arteriosclerosis or hypertension. \cite{nvsr2016}\\
	...
	\begin{enumerate}
		...
		SVM is a type of linear classifier that aims at finding a unique solution in the form of an optimal hyperplane. 
