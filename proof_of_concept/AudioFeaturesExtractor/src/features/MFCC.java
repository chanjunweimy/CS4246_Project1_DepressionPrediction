...
public class MFCC{
     ...
     * sample rate in Hz
     */
    protected final static double SAMPLING_RATE = 44100.0;
    /**
...
//    protected final static double preEmphasisAlpha = 0.95;
    protected static double preEmphasisAlpha = 0;
    /**
     ...
     */
    protected static int numMelFilters = 23;
    /**
    ...
    private void initializeClassVariables() {
        ...
        numCepstra = config.getMfccNumCepstra();
        preEmphasisAlpha = config.getMfccPreEmphasisAlpha();
        lowerFilterFreq = config.getMfccLowerFilterFrequency();
        upperFilterFreq = config.getMfccUpperFilterFrequency();
        numMelFilters = config.getMfccNumMelFilters();
    }
    ...
    public double[][] process(short inputSignal[]){
        ...
        for (int k = 0; k < frames.length; k++){
            ...
            // Mel Filtering
            int cbin[] = fftBinIndices(SAMPLING_RATE, 512);
            // get Mel Filterbank
